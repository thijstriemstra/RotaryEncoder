...
*/
/***************************************************************************************************/
#ifndef RotaryEncoderMCP23017_h
#define RotaryEncoderMCP23017_h
...
class RotaryEncoderMCP23017
{
  public:
    RotaryEncoderMCP23017(uint8_t encoderA, uint8_t encoderB, uint8_t encoderButton, Adafruit_MCP23017* mcp);
