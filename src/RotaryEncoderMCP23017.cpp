...
*/
/**************************************************************************/
RotaryEncoderMCP23017::RotaryEncoderMCP23017(uint8_t encoderA, uint8_t encoderB, uint8_t encoderButton, Adafruit_MCP23017* mcp)
{
  _encoderA      = encoderA;
  _encoderB      = encoderB;
...
*/
/**************************************************************************/
void RotaryEncoderMCP23017::begin()
{
  _mcp->pinMode(_encoderButton, INPUT);
  _mcp->pullUp(_encoderButton, HIGH);
  _mcp->pinMode(_encoderA, INPUT);
  _mcp->pinMode(_encoderB, INPUT);
  /*
...
*/
/**************************************************************************/
void RotaryEncoderMCP23017::readAB()
{
  noInterrupts();                                       //disable interrupts

  _currValueAB  = _mcp->digitalRead(_encoderA) << 1;
  _currValueAB |= _mcp->digitalRead(_encoderB);
...
*/
/**************************************************************************/
void RotaryEncoderMCP23017::readPushButton()
{
  noInterrupts();                             //disable interrupts

  _buttonState = _mcp->digitalRead(_encoderButton); //HIGH not pressed & LOW pressed, because internal pull-up resistor is enabled
...
*/
/**************************************************************************/
int16_t RotaryEncoderMCP23017::getPosition()
{
  return _counter;
}
...
*/
/**************************************************************************/
bool RotaryEncoderMCP23017::getPushButton()
{
...
*/
/**************************************************************************/
void RotaryEncoderMCP23017::setPosition(int16_t position)
{
  _counter = position;
}
...
*/
/**************************************************************************/
void RotaryEncoderMCP23017::setPushButton(bool state)
{
  _buttonState = ~state;
}
